...
public class Question_2 {
	...
	public static void main(String[] args) {
		...
		list.add(new orders(101,15200,"ACCEPTED"));
		list.add(new orders(102,14510,"COMPLETED"));
		list.add(new orders(103,5474,"COMPLETED"));
		list.add(new orders(104,45845,"ACCEPTED"));
